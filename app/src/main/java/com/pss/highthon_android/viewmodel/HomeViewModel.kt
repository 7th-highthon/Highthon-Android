...
class HomeViewModel @Inject constructor(
    ...
    //피드 게시물 클릭 이벤트
    val eventFeedClick: LiveData<Int> get() = _eventFeedClick
    private val _eventFeedClick = SingleLiveEvent<Int>()
    ...
    fun callEventFeedClick(content : Int) = _eventFeedClick.postValue(content)
}